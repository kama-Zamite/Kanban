  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-orange-50 to-white">
      <form onSubmit={handleSubmit} className="bg-white p-8 rounded-2xl shadow-2xl w-full max-w-md border border-orange-100 flex flex-col gap-4">
        <h2 className="text-2xl font-bold text-orange-500 mb-4">Login</h2>
        <input
          type="email"
          placeholder="E-mail"
          value={email}
        ...
        <input
          ...
          required
        />
        <button type="submit" className="bg-orange-500 hover:bg-orange-600 text-white font-bold py-2 rounded-lg shadow-lg transition-all">Entrar</button>
        <button type="button" className="bg-gray-200 hover:bg-gray-300 text-orange-500 font-bold py-2 rounded-lg shadow transition-all" onClick={() => navigate("/cadastro")}>Cadastrar</button>
      </form>
    </div>
  );
};
